...
def win_lose_msg(player_color, result, root):
    ...
    back = Image.open("gui/images/back.png")
    ...
    def display_win_lose_messages():
        ...
        if player_color == "white":
            if result == "1-0":  # assuming robot is playing black
                image_path = "gui/images/you_won.png"
            elif result == "0-1":
                image_path = "gui/images/you_lose.png"
                update_robot_win_count()
            elif result == "1/2-1/2":
                image_path = "gui/images/draw.png"
...
def levels_screen(root):
    ...
    choose_level = Image.open("gui/images/choose_level.png")
...
def game_screen(root):
    ...
    resign = Image.open("gui/images/resign.png")
    ...
    finished_move = Image.open("gui/images/move_finished.png")
...
def color_screen(root):
    for widget in root.winfo_children():
        if widget not in logo_widgets:  # Preserve logos
            clear_widget(widget)
    choose_color = Image.open("gui/images/choose_color.png")
    ...
    color1 = Image.open("gui/images/white.png")
    ...
    color2 = Image.open("gui/images/black.png")
...
def add_logos(root):
    ...
    killcount = Image.open("gui/images/killcount.png")
