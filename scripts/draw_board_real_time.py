...
def order_points(pts, image):
    ...
    rect[0] = top_right  # New top-left
    rect[1] = top_left  # New top-right
    rect[2] = bottom_left  # New bottom-left
    rect[3] = bottom_right  # New bottom-right
...
def detect_aruco_markers(image):
    ...
    if ids is not None and len(ids) == 4:
        ...
        ordered_points = order_points(all_points, image)
